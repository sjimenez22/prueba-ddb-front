...
const openModal = () => {
   ...
   taskService.getTask(props.idTask).then((res: any) => {
      if (res.data) {
         ...
         task.fk_project = res.data.data.project.pk_project;
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form @submit.prevent="update()">
                  ...
                  <div class="mb-3 text-start">
                     <label for="ProjectUpdate" class="form-label">Seleccione un proyecto</label>
                     <select class="form-select" id="ProjectUpdate" aria-label="Seleccione un proyecto"
                        v-model="task.fk_project">
                        <option v-for="project of projects" :value="project.pk_project">{{ project.c_name }}</option>
                     </select>
                  </div>
